...
<input type="hidden" name="gCode" value="<%=gCode %>"><!-- orderDTO에 넘김 -->
<input type="hidden" name="gName" value="<%= gName %>"><!-- 넘어가지 않는 데이터들 추가로 넘기고 싶을때 hidden으로 같이 넘김 -->
...
<input type="hidden" name="orderNum" value="<%= num %>"><!-- 장바구니 번호 --><!-- 여기서 orderinfo 테이블 만듦 -->
<!-- cart에서 삭제 시 사용 (결제할 때 삭제됨) -->
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<%= gName %>	<br> <font size="2" color="#665b5f">[옵션 : 사이즈(<%= gSize %>)
								, 색상(<%= gColor %>)]
						</font></td>
